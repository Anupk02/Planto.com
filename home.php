...
<body>
    ...
    <li>
      ...
      <li><a href="fedback.html">Feadback</a></li>
    ...
    <li>
        ...
        <div class="dropdown-content">
          ...
          <li><a class="menu__item" href="index.php">Blog or Tips</a></li>
          <li><a class="menu__item" href="index.php">Feadback</a></li>
      ...
      <button class="button">Search</button>
          ...
          <div class="box1" >
          <a href="" class="btn-search" style="color:green;"><i class="fa-solid fa-user"></i>  <?php echo $_SESSION['user'] ?></a>
...
<input name="ship-address" class="ship-address" required placeholder="Enter a location" value="<?php echo isset($_SESSION['address']) ? $_SESSION['address'] : ''; ?>" style="
    padding: 3px;
    margin-bottom: 6px;
">
